                    ...
                    for (var s in n) 
                        if (Object.prototype.hasOwnProperty.call(n, s)) {
                            ...
                            if (!new RegExp(r).test(a)) 
                                throw new Error(
                                    t.toUpperCase() + ': Option "' + s + '" provided type "' + a + '" but expected ' +
                                    'type "' + r + '".'
                                )
                        }
                    var l
            ...
            var e = "carousel",
                ...
                C = function () {
                    ...
                    C.nextWhenVisible = function () {
                        !document.hidden && t(this._element).is(":visible") && "hidden" !== t(
                            this._element
                ...
                m = function () {
                    ...
                    o.show = function () {
                        ...
                        if (!this._isTransitioning && !t(this._element).hasClass(c) && (
                            this._parent && 0 === (e = t.makeArray(t(this._parent).find(p.ACTIVES).filter(
                        ...
                        return this.each(function () {
                            ...
                            if (n || (n = new a(
                                ...
                                "object" == typeof e
                                    ? e
                                    : null
                            ), t(this).data(i, n)), "string" == typeof e) {
                ...
                I = function () {
                    ...
                    I.show = function () {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            t.contains(this.element.ownerDocument.documentElement, this.tip) || t(r).appendTo(
                                c
                            ),
                    ...
                    I._getConfig = function (n) {
                        return "number" == typeof(
                            n = r({}, this.constructor.Default, t(this.element).data(), n)
                        ).delay && (n.delay = {
                            show: n.delay,
                            hide: n.delay
                        }),
